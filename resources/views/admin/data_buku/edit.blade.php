    ...
    <div class="pt-1">
        <div class="flex justify-center items-center min-h-[80vh] py-6 px-4">
            <div class="w-full max-w-5xl min-h-100 bg-white bg-slate-800 p-6 rounded-lg shadow-lg">
                ...
                <!-- Judul -->
                <h2 class="text-center text-2xl font-bold text-gray-800 mb-6 text-white">Edit Data Alat</h2>
                ...
                <form action="{{ route('admin.data-buku.update', $Buku->id) }}" method="POST" id="editForm"
                    ...
                    @method('PATCH')
                    <div class="mb-4">
                        <label for="judul_buku" class="block text-gray-700 font-semibold mb-2 text-gray-300">Judul
                            Buku</label>
                    ...
                    <div class="mb-4">
                        <label for="penulis" class="block text-gray-700 font-semibold mb-2 text-gray-300">Penulis
                            Buku</label>
                    ...
                    <div class="mb-4">
                        ...
                        <label for="kategori_id" class="block text-gray-700 font-semibold mb-2 text-gray-300">Kategori
                            Alat</label>
                    ...
                    <div class="mb-4">
                        <label for="stok" class="block text-gray-700 font-semibold mb-2 text-gray-300">Stok
                            Alat</label>
