...
@section('content')
    <div class="pt-1">
        <div class="flex justify-center items-center min-h-[80vh] py-6 px-4">
            <div class="w-full max-w-5xl min-h-100 bg-white p-6 rounded-lg shadow-lg">
                <div class="mb-4">
                ...
                <!-- Judul -->
                <h2 class="text-center text-2xl font-bold text-gray-800 mb-6">Edit Data Alat</h2>
                ...
                <form action="{{ route('admin.data-buku.update', $Buku->id) }}" method="POST" id="editForm"
                    ...
                    @method('PATCH')
                    <div class="mb-4">
                        <label for="judul_buku" class="block text-gray-700 font-semibold mb-2">Judul
                            Buku</label>
                    ...
                    <div class="mb-4">
                        <label for="penulis" class="block text-gray-700 font-semibold mb-2">Penulis
                            Buku</label>
                    ...
                    <div class="mb-4">
                        ...
                        <label for="kategori_id" class="block text-gray-700 font-semibold mb-2">Kategori
                            Alat</label>
                    ...
                    <div class="mb-4">
                        <label for="stok" class="block text-gray-700 font-semibold mb-2">Stok
                            Alat</label>
                    ...
                    <div class="mb-4">
                        <label for="foto_buku" class="block text-gray-700 font-semibold mb-2">
                            Foto Buku</label>
                        @if ($Buku->foto_buku)
                            <div class="mb-2">
