...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 px-1 mb-2">
        <div class="bg-white bg-slate-800 p-4 rounded-2xl border border-slate-200/60 border-slate-700">
            <div class="flex items-center justify-between mb-2">
                ...
                <div class="w-8 h-8 rounded-lg bg-blue-100 bg-blue-900/40 flex items-center justify-center">
                    <i class="fas fa-box text-sm text-blue-600 text-blue-400"></i>
                </div>
            </div>
            <h3 class="text-2xl font-bold text-slate-800 text-white">09</h3>
        ...
        <div class="bg-white bg-slate-800 p-4 rounded-2xl border border-slate-200/60 border-slate-700">
            <div class="flex items-center justify-between mb-2">
                ...
                <div class="w-8 h-8 rounded-lg bg-blue-100 bg-blue-900/40 flex items-center justify-center">
                    <i class="fas fa-tags text-sm text-blue-600 text-blue-400"></i>
                </div>
            </div>
            <h3 class="text-2xl font-bold text-slate-800 text-white">723</h3>
            <p class="text-[11px] text-slate-400">Total</p>
        </div>
        ...
        <div class="bg-white bg-slate-800 p-4 rounded-2xl border border-slate-200/60 border-slate-700">
            <div class="flex items-center justify-between mb-2">
                ...
                <div class="w-8 h-8 rounded-lg bg-blue-100 bg-blue-900/40 flex items-center justify-center">
                    <i class="fas fa-qrcode text-sm text-blue-600 text-blue-400"></i>
                </div>
            </div>
            <h3 class="text-2xl font-bold text-slate-800 text-white">234</h3>
            <p class="text-[11px] text-slate-400">Total</p>
        </div>

        <div class="bg-white bg-slate-800 p-4 rounded-2xl border border-slate-200/60">
            <div class="flex items-center justify-between mb-2">
                <p class="text-xs text-slate-500">Total Stok</p>
                <div class="w-8 h-8 rounded-lg bg-tertiary/100 bg-blue-900/40 flex items-center justify-center">
                    <i class="fas fa-cubes text-sm text-primary text-blue-400"></i>
                </div>
            </div>
            <h3 class="text-2xl font-bold text-slate-800 text-white">098</h3>
            <p class="text-[11px] text-slate-400">Total</p>
        </div>
    </div>
    ...
    <div class="p-4 md:p-2 overflow-x-hidden mt-4 min-h-screen">
        <div class="bg-white bg-slate-800 text-gray-900 text-gray-100 p-4 rounded-lg shadow-md shadow-lg">
            <h2 class="text-center text-xl font-bold mb-4 text-gray-800 text-white">Kategori Management</h2>
            ...
            <div class="overflow-x-auto mt-4">
                <table id="kategoriTable" class="w-full border border-gray-300 text-xs md:text-sm border-gray-600">
                                ...
                                <td class="border border-gray-300 px-2 py-1 md:px-4 md:py-2 text-center">
                                    <div class="flex justify-center space-x-1 md:space-x-2">
                                        <a href="{{ route('admin.kategori-alat.edit', $row->id) }}"
                                            class="text-amber-600 hover:text-white bg-amber-50 hover:bg-amber-500 bg-amber-900/30 hover:bg-amber-600 p-3 rounded-xl transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-110">
