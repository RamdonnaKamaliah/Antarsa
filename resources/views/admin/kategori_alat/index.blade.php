...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 px-1 mb-2">
        ...
        <div class="bg-white p-4 rounded-2xl border border-slate-200/60">
            ...
            <h3 class="text-2xl font-bold text-slate-800">723</h3>
            <p class="text-[11px] text-slate-400">Total</p>
        </div>
        ...
        <div class="bg-white p-4 rounded-2xl border border-slate-200/60">
            ...
            <h3 class="text-2xl font-bold text-slate-800">234</h3>
            <p class="text-[11px] text-slate-400">Total</p>
        </div>
    ...
    <div class="p-4 md:p-2 overflow-x-hidden mt-4 min-h-screen">
        <div class="bg-white text-gray-900 p-4 rounded-lg shadow-md">
            <h2 class="text-center text-xl font-bold mb-4 text-gray-800">Kategori Management</h2>
            ...
            <div class="overflow-x-auto mt-4">
                <table id="kategoriTable" class="w-full border border-gray-300 text-xs md:text-sm">
      ...
      p-3 rounded-xl transition-all duration-300 shadow-md hover:shadow-lg cursor-pointer transform hover:scale-110"
