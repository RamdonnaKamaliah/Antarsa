...
@section('content')
    ...
    <div id="actionModal" class="hidden fixed inset-0 z-50 flex justify-center items-center bg-black/50">
        <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl w-full max-w-md p-6 transform transition-all">
            <div class="text-center">
                ...
                <p class="text-gray-500 dark:text-gray-400 mb-4">
                    ...
                    <span id="targetBuku" class="font-bold text-gray-700 dark:text-gray-200"></span>
                    oleh <span id="targetUser" class="font-bold text-gray-700 dark:text-gray-200"></span>
                </p>
            </div>
            ...
            <form id="modalForm" method="POST">
                ...
                <div id="alasanContainer" class="hidden mb-4">
                    <label class="block text-left text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Alasan
                        Penolakan:</label>
                    <textarea name="alasan_penolakan" rows="3"
                        class="w-full rounded-lg border-gray-300 dark:bg-slate-700 dark:text-white focus:ring-red-500"
    ...
    function openModal(type, id, userName, bukuTitle) {
        ...
        if (type === 'approve') {
            ...
            iconContainer.className = "mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-blue-500 mb-4";
            ...
            confirmBtn.className = "px-5 py-2 bg-orange-600 hover:bg-orange-700 text-white rounded-lg transition shadow-lg";
            iconContainer.className = "mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-orange-500 mb-4";
