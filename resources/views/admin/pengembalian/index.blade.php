...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 px-1 mb-2">
        ...
        <div class="bg-white bg-slate-800 p-4 rounded-2xl border border-slate-200/60 border-slate-700">
            ...
            <h3 class="text-2xl font-bold text-slate-800 text-white">{{ $stats['total_pengembalian'] }}</h3>
        ...
        <div class="bg-white bg-slate-800 p-4 rounded-2xl border border-slate-200/60 border-slate-700">
            ...
            <h3 class="text-2xl font-bold text-slate-800 text-white">{{ $stats['total_catatan'] }}</h3>
            <p class="text-[11px] text-slate-400">Count</p>
        </div>
        ...
        <div class="bg-white bg-slate-800 p-4 rounded-2xl border border-slate-200/60 border-slate-700">
            ...
            <h3 class="text-2xl font-bold text-slate-800 text-white">{{ $stats['total_kondisiRusak'] }}</h3>
            <p class="text-[11px] text-slate-400">Count</p>
        </div>
        ...
        <div class="bg-white bg-slate-800 p-4 rounded-2xl border border-slate-200/60 border-slate-700">
            ...
            <h3 class="text-2xl font-bold text-slate-800 text-white">{{ $stats['total_kondisiBaik'] }}</h3>
